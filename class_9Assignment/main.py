...
triage_agent = Agent(
    ...
    handoffs=[
        ...
        handoff(
            ...
            tool_description_override="handoff to hotel agent for hotel booking",
            is_enabled=handoff_permission,
            input_filter=handoff_filter,
            input_guardrails=[reject_Indian_cites],
            output_guardrails=[reject_US_cites]
        ...
        handoff(
            ...
            tool_description_override="handoff to flight agent for flight booking",
            is_enabled=handoff_permission,
            input_filter=handoff_filter,
            input_guardrails=[reject_Indian_cites],
            output_guardrails=[reject_US_cites]
    ...
    handoff_description="""
    Triage agent routes requests to flight, hotel, or weather agent if needed.""",
)
